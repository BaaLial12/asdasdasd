...
namespace PSS.lhm232.Practica_04
{
    public class UserData
    {
        ...
        public void CargarDatos()
        {
            ...
            {
                new Personal { Id = 1, UsuarioId = 1, AplicacionId = 1, Password = "pss-1", Email = "", EstaBloqueado = false, FechaAlta = new DateTime(1980, 1, 9, 3, 0, 0) },
                new Personal { Id = 2, UsuarioId = 2, AplicacionId = 2, Password = "pss-2", Email = "Juan.pss2@ual.es", EstaBloqueado = false, FechaAlta = new DateTime(1979, 4, 6, 5, 0, 0) },
                new Personal { Id = 4, UsuarioId = 3, AplicacionId = 1, Password = "pss3", Email = "Antonio.pss-3@hotmail.es", EstaBloqueado = false, FechaAlta = new DateTime(1980, 2, 6, 7, 0, 0) },
                new Personal { Id = 5, UsuarioId = 4, AplicacionId = 1, Password = "pss-4", Email = "", EstaBloqueado = false, FechaAlta = new DateTime(1982, 4, 7, 9, 0, 0) },
                new Personal { Id = 6, UsuarioId = 5, AplicacionId = 3, Password = "pss-5", Email = "Jose.pss5@ual.es", EstaBloqueado = false, FechaAlta = new DateTime(1960, 5, 5, 6, 0, 0) },
                new Personal { Id = 5, UsuarioId = 4, AplicacionId = 1, Password = "pss-4", Email = "", EstaBloqueado = false, FechaAlta = new DateTime(1982, 4, 7, 9, 0, 0) },
                new Personal { Id = 6, UsuarioId = 5, AplicacionId = 3, Password = "pss-5", Email = "Jose.pss5@ual.es", EstaBloqueado = false, FechaAlta = new DateTime(1960, 5, 5, 6, 0, 0) },
            };
            Categorias = new List<Categoria>
 {
            ...
            Aplicaciones = new List<Aplicacion>
             ...
             new Aplicacion{Id=3,
            NombreAplicacion="GestionUsuarios",Path=@"c:\gestionusuarios"},
        ...
        {
            var nombreArchivo = "datos.xml";
            var rutaCarpeta = "C:\\Users\\paula\\source\\Repos\\2022-pss-lhm232-ual\\Práctica4\\datosXML.xml";
